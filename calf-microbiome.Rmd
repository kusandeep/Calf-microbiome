...
plot(PCOdata[,1:2], pch=19, xlim=xlim1,
     xlab=xlab1, ylab=ylab1, col=mycol2[calfsmartdata$Diet])
minor.tick(nx=5,ny=5)
legend("topleft", bty="o", pch=19, cex=0.9, pt.cex=0.9, x.intersp=1, col=mycol2, horiz=F, 
       legend=levels(calfsmartdata$Diet), title="Diet")
par(xpd=FALSE)
dataEllipse(PCOdata[,1],PCOdata[,2],as.factor(calfsmartdata$Diet), col=mycol2,
